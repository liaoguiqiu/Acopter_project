...
void GPS_Kalman::gps_kalman_update(float detT)
{
 ...
 if(gps_kalman_start_flag)
 {
  ...
  Xkfin_f32[0]=gps.px*1000.0,
  Xkfin_f32[1]=gps.vn*1000.0,
  Xkfin_f32[2]=-position.wx_acc,
  Xkfin_f32[3]=gps.py*1000.0,
  Xkfin_f32[4]=gps.ve*1000.0,
  ...
  xkf_px=(float)Xkfout.pData[0];
  xkf_vn=(float)Xkfout.pData[1];;//(float)Xkfout.pData[1];
  xkf_accx=(float)Xkfout.pData[2];
  xkf_py=(float)Xkfout.pData[3];
  xkf_ve=(float)Xkfout.pData[4];
  xkf_accy=(float)Xkfout.pData[5];
}